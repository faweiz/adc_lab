...
HD_PWD='E:/FPGA/Project/Lab10/adc_lab/vivado/adc_lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log toplevel_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source toplevel_tb.tcl
